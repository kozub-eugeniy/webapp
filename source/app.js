...
window.onload = function () {
    ...
    var line = document.getElementById('brushSlider');
    ...
    var PICKER = {
        ...
        bind_inputs: function bind_inputs() {
        ...
        close: function close() {
            PICKER.$colors.fadeOut(PICKER.$colors.remove);
        },

        get_color: function get_color(e) {
